...
public class Products {
    ...
    private String description; // renamed to lower-case
    ...
    public Products(Long id, String name, Double price, String description,String category, Double ratings, String seller, Integer stock) {
        this.id = id;
        this.stock = stock;
        this.price = price;
        this.name = name;
    ...
    // getters / setters for all fields (include images and reviews)
    ...
    // fixed: standard camelCase getter/setter for numOfReviews
